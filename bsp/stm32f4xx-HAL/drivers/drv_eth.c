...
#define KS8721BL_PHY_ADDRESS           0x01U
...
#define PHY_REG_INTERRUPT   0x1B     /* Specified interrupt Register             	 */
#define PHY_REG_SRECR       0x15     /* Specified Receive Error Counter  			 */
...
void HAL_ETH_MspInit(ETH_HandleTypeDef* heth)
{
    ...
    if(heth->Instance==ETH)
    {
        ...
        */
        ...
        GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_8|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_12|GPIO_PIN_13;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
        GPIO_InitStruct.Alternate = GPIO_AF11_ETH;
...
static rt_err_t rt_stm32_eth_init(rt_device_t dev)
{
	...
	EthHandle.Init.PhyAddress = KS8721BL_PHY_ADDRESS;
